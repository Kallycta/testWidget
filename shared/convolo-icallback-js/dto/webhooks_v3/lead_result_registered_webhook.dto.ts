...
export const zICallbackWebhookLeadResultRegisteredPayload = z.object({
    type: z.literal('lead_result_registered'),
    lead_result: z.string(),
    lead_result_raw: z.string(),
...
export type ICallbackWebhookLeadResultRegisteredPayload = z.infer<
    typeof zICallbackWebhookLeadResultRegisteredPayload
>;
