...
export const zICallbackWebhookEndCallbackPayload = z.object({
    type: z.literal('end_callback'),
    call_id: zICallbackVisitStringId,
    user_id: zUserId,
    widget_key: zICallbackWidgetKey,
    widget_name: z.string(),
    call_status: z.enum(['answered', 'missed']),
...
export type ICallbackWebhookEndCallbackPayload = z.infer<
    typeof zICallbackWebhookEndCallbackPayload
>;
