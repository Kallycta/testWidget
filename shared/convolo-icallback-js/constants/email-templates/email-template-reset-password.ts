...
export const EMAIL_TEMPLATE_RESET_PASSWORD: EmailTemplateType = {
    title: `Convolo password reset`,
    html: `<!DOCTYPE html>
<html>
        ...
        <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px;'>
          <tr>
            <td align='start' bgcolor='#ffffff'
              ...
              <h1 style='margin-bottom: 35px; font-size: 30px; font-weight: 500; line-height: 35px;'>Reset your password</h1>
            </td>
          </tr>
        </table>
        <!--[if (gte mso 9)|(IE)]>
        ...
        <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px;'>
          ...
          <tr>
            <td align='start' bgcolor='#ffffff'
              ...
              <p style='margin: 0;'>Hello <span style='color: #1f82fc; text-decoration: underline;'> {{username}} </span>,</p>
            </td>
          </tr>
          <tr>
            <td align='start' bgcolor='#ffffff'
              style='padding: 0 30px 15px; font-family: Roboto; font-size: 16px; line-height: 21px; font-weight: 400;'>
              <p style='margin: 0;'>We have received a request to change your password. You can do this through the link below.</p>
            </td>
          </tr>
          ...
          <tr>
            <td align='left' bgcolor='#ffffff'>
              <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                <tr>
                  <td align='center' bgcolor='#ffffff' style='padding: 30px 30px;'>
                      ...
                      <tr>
                        <td align='center' bgcolor='#0074ff' style='border-radius: 8px;' >
                          <a href='{{resetLink}}' target='_blank'
                            ...
                            padding: 16px 36px; font-family: Roboto; font-size: 20px; 
          ...
          <tr>
            <td align='start' bgcolor='#ffffff'
              style='padding: 0 30px 15px; font-family: Roboto; font-size: 16px; line-height: 21px; font-weight: 400;'>
              <p style='margin: 0;'>If you didn't make this request, you can safely ignore this email. <span> </span>,</p>
            </td>
          </tr>
          <tr>
            <td align='start' bgcolor='#ffffff'
              style='padding: 0 30px 15px; font-family: Roboto; font-size: 16px; line-height: 21px; font-weight: 400;'>
              <p style='margin: 0;'>Your password won't change unless you visit the link above and create a new one.</p>
            </td>
          </tr>
          <tr>
            <td align='left' bgcolor='#ffffff'
